...
function Export-VisioPptx {
    ...
    try {
        ...
        $picture = $slide.Shapes.AddPicture($svgPath, $false, $true, 0, 0, $pageWidthPt, $pageHeightPt)
        ...
        if ($powerPoint -ne $null) {
            ...
            try { [Runtime.InteropServices.Marshal]::FinalReleaseComObject($powerPoint) | Out-Null } catch {}
        }
